...
root = tk.Tk()
root.title("Приложение для компании ООО АВТОУНЕВЕР")
...
try:
    ...
    background2_image = Image.open("background2.png")
    ...
    background3_image = Image.open("background3.png")
    ...
    traceback.print_exc()
    print("Ошибка при загрузке и изменении размеров изображения фона, background2.png и background3.png:", e)
